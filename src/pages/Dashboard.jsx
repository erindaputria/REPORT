...
export function Dashboard() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Left Sidebar */}
      <div className="w-64 bg-white-900 text-red-500 p-4 flex flex-col">
        {/* Logo */}
        ...
        <nav className="flex-1 space-y-2">
          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <Home size={20} className="text-[#507687]" /> Beranda
          </button>

          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <div className="w-5 h-5 bg-[#507687]/40 rounded-full" /> blablabla
          </button>

          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <Heart size={20} className="text-[#507687]" /> blablabla
          </button>

          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <Folder size={20} className="text-[#507687]" /> blablabla
          </button>

          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <Settings size={20} className="text-[#507687]" /> blablabla
          </button>

          <button className="w-full flex items-center gap-3 px-3 py-4 rounded-full bg-white text-[#507687] hover:bg-[#507687]/40">
            <FileText size={20} className="text-[#507687]" /> blablabla
          </button>
        </nav>
      </div>
      ...
      <div className="flex-1 p-6">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="relative flex-1 max-w-md">
            <input
              ...
              className="w-full pl-3 pr-12 py-2 rounded-full bg-gray-100 focus:ring-2 focus:ring-blue-500 outline-none placeholder:font-semibold placeholder:text-gray-500"
            />
            <div className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center rounded-full bg-white shadow">
              <Search className="text-[#507687]" size={18} />
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-8 justify-center">
          <div className="bg-[#507687] text-white rounded-[2rem] shadow p-8 min-h-[280px] max-w-md flex flex-col justify-between text-left">
            <div>
            ...
            <button className="self-start px-4 py-2 border border-white rounded-full font-bold hover:bg-white hover:text-[#507687] transition">
        ...
        <div className="mb-8">
          ...
          <div className="flex gap-4">
            ...
            <div className="flex flex-col items-center">
              <div className="w-40 h-40 bg-[#507687] rounded-2xl flex items-center justify-center hover:shadow">
                <svg
                  width="60"
                  height="66"
                  viewBox="0 0 60 66"
        ...
        <div className="mt-8">
          ...
          {/* Card peringatan */}
          <div className="bg-white rounded-2xl p-3 flex items-center mb-4 shadow-sm border border-gray-200">
            {/* Logo peringatan */}
            <div className="w-6 h-6 flex items-center justify-center border-2 border-gray-400 rounded-full mr-3 font-bold text-gray-600">
              !
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            {[1, 2, 3].map((item) => (
              <div
                key={item}
                className="bg-white rounded-2xl p-3 text-center shadow-sm border border-gray-200"
              >
                <div className="w-16 h-16 bg-gray-200 rounded-xl mx-auto mb-3"></div>
                <p className="text-gray-500 text-sm">~ blablabla</p>
              </div>
            ))}
          </div>
        </div>
      ...
      {/* Right Sidebar */}
      <div className="w-80 p-6 bg-[#507687] space-y-4">
        {/* Notifikasi + Profil */}
        <div className="flex items-center justify-between gap-2">
          ...
          {/* Card Profil */}
          <div className="flex-1 bg-white rounded-full flex items-center justify-between px-2 py-1.5 shadow-sm border border-gray-200">
        ...
        <div className="bg-white rounded-lg border p-3 flex items-center gap-2">
          ...
          <span className="font-medium text-[#507687]">Tanya ChatBot</span>
        </div>
      </div>
    </div>
  );
