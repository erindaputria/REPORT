              ...
              <div className="mt-8 space-y-6 text-left">
                <div className="text-gray-800">
                  ...
                  <div className="mt-2 text-sm space-y-4">
                    <p>
                      Kami informasikan bahwa saat ini terjadi gangguan jaringan
                      pada pusat data kota yang berdampak pada akses layanan
                      tiket dan sistem internal di seluruh OPD. Akibat gangguan
                      ini, perhitungan SLA (Service Level Agreement) untuk
                      seluruh tiket dihentikan sementara hingga sistem kembali
                      normal.
                    </p>
