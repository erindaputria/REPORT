                ...
                <div className="text-gray-800">
                  ...
                  <div className="mt-2 text-sm space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        <p className="flex items-start gap-2">
                          <span>🏛️</span>
                          <span>
                            Upacara peringatan Hari Jadi Kota Surabaya di Balai
                            Kota.
                          </span>
                        </p>
                        <p className="flex items-start gap-2">
                        ...
                        <p className="flex items-start gap-2">
                          <span>🎉</span>
                          <span>
                            Malam puncak perayaan dengan konser rakyat di Taman
                            Surya.
                          </span>
                        </p>
                      </div>
                    ...
                    <p>
                      ...
                      serta menjaga ketertiban, kebersihan, dan semangat gotong
                      royong selama rangkaian kegiatan berlangsung.
                    </p>
