...
export default function LihatArtikelKota() {
  ...
  return (
    <div className="p-8 space-y-6">
      {/* Header */}
      <h1 className="text-3xl font-bold text-[#0F2C59]">{artikel.judul}</h1>
      <p className="text-gray-600 font-medium">Dari: {artikel.penulis}</p>
