              ...
              <div className="p-6 space-y-6">
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div className="flex-1 relative">
                    ...
                    >
                      <option value="">Pilih sistem atau aplikasi</option>
                    </select>
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="text-xs text-gray-500">
                    Jelaskan dengan rinci terkait hal ini agar kami
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p className="text-xs text-gray-500">
                    Lampirkan bsurat persetujuan atau dokumen pendukung terkait untuk membantu kami
                    menindaklanjuti pengajuan Anda sesuai prosedur keamanan!
                  </p>
