  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Mobile Header */}
        <div className="bg-white p-4 flex items-center justify-between md:hidden shadow-sm border-b sticky top-0 z-10">
          <button
      ...
      <div
        ...
        } lg:block w-80 bg-[#226597] p-6 space-y-4 fixed lg:relative right-0 top-0 h-full lg:h-auto z-20 lg:z-auto overflow-y-auto`}
      >
        {/* Tombol tutup untuk mobile */}
        <div className="flex justify-between items-center lg:hidden mb-4">
          <h2 className="text-xl font-bold text-white">Informasi</h2>
          <button
              ...
              <div className="absolute top-full left-0 mt-2 w-72 bg-white rounded-lg shadow-lg border border-gray-200 py-2 z-50">
                ...
                <div className="max-h-96 overflow-y-auto">
                  ...
                  <div
                    ...
                    onClick={() => navigate("/ndibuatmasyarakat")}
                  >
                    <div className="flex items-start gap-2">
                      <svg
                        width="32"
                  ...
                  <div
                    className="px-3 py-2 border-b border-gray-100 hover:bg-gray-50 cursor-pointer"
                    onClick={() => navigate("/ndiprosesmasyarakat")}
                  >
                    <div className="flex items-start gap-2">
                      <svg
                        width="32"
                  ...
                  <div
                    ...
                    onClick={() => navigate("/nmaintenancemasyarakat")}
                  >
                    <div className="flex items-start gap-2">
                      <svg
                        width="32"
